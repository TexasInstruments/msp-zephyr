...
#define MSPM0_FLASH_NODE	DT_INST_CHILD(0, flash_0)
#define FLASH_MSPM0_BASE_ADDRESS DT_REG_ADDR(MSPM0_FLASH_NODE)
#define FLASH_CMDWAIT_TIMEOUT	500

#if DT_PROP(MSPM0_FLASH_NODE, write_block_size)
#define FLASH_MSPM0_WRITE_BLOCK_SIZE DT_PROP(MSPM0_FLASH_NODE, write_block_size)
#else
