...
#ifndef __ZEPHYR_SOC_ARM_TI_MSPM33_PINCTRL_SOC_H__
#define __ZEPHYR_SOC_ARM_TI_MSPM33_PINCTRL_SOC_H__
...
#define MSP_GPIO_OPEN_DRAIN_OUTPUT	(25)  //needs to be updated to HIZ
...
#endif /* __ZEPHYR_SOC_ARM_TI_MSPM33_PINCTRL_SOC_H__ */
